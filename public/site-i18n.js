...
(() => {
  ...
  const exact = new Map(Object.entries({
    ...
    '首页':'Home','在线连接':'Online Connection','离线报文解析':'Offline Message Analysis','CAN报文解析':'CAN Message Analysis','格式转换':'Format Conversion','27930报文分析':'GB/T 27930 Analysis','J939分析':'J1939 Analysis','友情链接':'Links','关于本站':'About',
    'CAN报文解析 · CANAnalysis':'CAN Message Analysis · CANAnalysis','在线连接 · CANAnalysis':'Online Connection · CANAnalysis','格式转换 · CANAnalysis':'Format Conversion · CANAnalysis','关于本站 · CANAnalysis':'About · CANAnalysis',
